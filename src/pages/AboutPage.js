...
function AboutPage() {
    return (
      <div className="about-page">
        ...
        As technology and practices have evolved, the role of women as programmers has changed and history has downplayed their achievements.
        The first algorithm to be executed by a computer was designed by Ada Lovelace, who was a pioneer in the field. 
        ...
        Adacodes is a platform for sharing resources, providing the tools to expand knowledge and networking. 
        Our list of opportunities and events in the area is constantly updated also thanks to your valuable contributions.
        Following the spirit of Ada Lovelace, we advocate for more diversity in the technology world. Join the community!
        </p>
        <div>
          <img className="about-pic" src="https://64.media.tumblr.com/2ac0a963a21ddfaacbb30210f336522e/1c254e4721b2abb1-c8/s1280x1920/0b8bcd6bdf8ef05009f660bfc1bf1b38fda87013.jpg" alt="first-programmer" width="300px" />
        </div>
        </div>
